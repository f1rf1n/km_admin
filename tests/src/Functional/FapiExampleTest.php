...
/**
 * Ensure that the km_admin forms work properly.
 *
 * @group km_admin
 * @group examples
 *
...
class FapiExampleTest extends ExamplesBrowserTestBase {
  ...
  public function doTestRoutes() {
    ...
    $routes = [
      ...
      'km_admin.simple_form' => ['Submit'],
      'km_admin.input_demo' => ['Submit'],
      'km_admin.state_demo' => ['Submit'],
      'km_admin.container_demo' => ['Submit'],
      'km_admin.vertical_tabs_demo' => ['Submit'],
      // Modal form has a submit button, but requires input.
      'km_admin.modal_form' => [],
      'km_admin.ajax_color_demo' => ['Submit'],
      'km_admin.build_demo' => ['Submit'],
      'km_admin.ajax_addmore' => ['Submit'],
  ...
  public function doTestAjaxColorForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('km_admin.ajax_color_demo'), $edit, 'Submit');
  ...
  public function doTestBuildDemo() {
    $assert = $this->assertSession();
    $build_demo_url = Url::fromRoute('km_admin.build_demo');
  ...
  public function doTestContainerDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('km_admin.container_demo'), $edit, 'Submit');
  ...
  public function doTestInputDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('km_admin.input_demo'), $edit, 'Submit');
    $assert->statusCodeEquals(200);
  ...
  public function doTestModalForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('km_admin.modal_form'), $edit, 'Submit');
    $assert->pageTextContains('Submit handler: You specified a title of My Book.');
  }

  /**
   * Check routes defined by km_admin.
   */
  public function doTestSimpleFormExample() {
    ...
    $this->drupalPostForm(Url::fromRoute('km_admin.simple_form'), $edit, 'Submit');
  ...
  public function doTestStateDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('km_admin.state_demo'), $edit, 'Submit');
  ...
  public function doTestAjaxAddMore() {
    ...
    $ajax_addmore_url = Url::fromRoute('km_admin.ajax_addmore');
